...
# MAGIC %md
# MAGIC # databricks-dolly-15k-jaでRWKVのファインチューニング
# MAGIC 
# MAGIC - [Alpacaデータセットによる RWKV のファインチューニングを試す｜npaka｜note](https://note.com/npaka/n/n91e6dfecd034)
...
# MAGIC - [databricks\-dolly\-15k\-ja\.json · kunishou/databricks\-dolly\-15k\-ja at main](https://huggingface.co/datasets/kunishou/databricks-dolly-15k-ja/blob/main/databricks-dolly-15k-ja.json)
...
# MAGIC ## ライブラリのインストール
# MAGIC 
# MAGIC Databricksランタイムに入っていないgit-lfsをインストールします。
# MAGIC 
...
rwkv_dir_local = "/dbfs/tmp/takaaki.yayoi@databricks.com/rwkv" # local file API用

# COMMAND ----------

# データセットを移動
#dbutils.fs.mv("dbfs:/FileStore/shared_uploads/takaaki.yayoi@databricks.com/databricks_dolly_15k_ja.json", rwkv_dir)
...
# MAGIC ## ベースモデルのダウンロード
# MAGIC 
# MAGIC [BlinkDL \(BlinkDL\)](https://huggingface.co/BlinkDL)
# MAGIC 
# MAGIC オプション:
...
input_file = f"{rwkv_dir_local}/databricks_dolly_15k_ja.txt"
