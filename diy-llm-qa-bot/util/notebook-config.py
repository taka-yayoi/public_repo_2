...
# ベクトルストアの格納パス
config['vector_store_path'] = '/dbfs/tmp/takaaki.yayoi@databricks.com/qabot/vector_store' # /dbfs/... はローカルファイルシステムにおける表現です
...
config['serving_endpoint_name'] = "llm-qabot-endpoint-taka" # サービングエンドポイント名
